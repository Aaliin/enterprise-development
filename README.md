...
## Структура проекта:
* EstateAgency.API - Веб-интерфейс
* EstateAgency.Application - Сервисный слой
* EstateAgency.Domain - Предметная оюласть
* EstateAgency.Infrastructure -  Слой для доступа к данным
* EstateAgency.Tests - Тестирование
